...
SET SRC_VERSION=$SRC_BASE\Builds\AppBuild\Windows\32\AppBuild.inc
...
SET SRC_BIN=$SRC_BASE\Builds\Aurawin\%APP%\Windows\32\%SRC_EXE%
...
echo %SRC_LIC%
SET SRC_PATH=$SRC_BASE\Install\Aurawin\%APP%\Windows\32
SET SRC_PACK=$SRC_BASE\Builds\Aurawin\AuPackage\Windows\32
SET SRC_BUILD_BASE=$SRC_BASE\Builds\Aurawin\%APP%
SET SRC_BUILD=%SRC_BUILD_BASE%\Windows\32

echo Changing path to %SRC_PATH%
cd %SRC_PATH%
