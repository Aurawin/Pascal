*********************************************************************
Aurawin Console for Social Computing Server  (Aurawin SCS)
Version 2013 compiled for Linux
Email: support@aurawin.com
Suggested Aurawin Networks: Aurawin SCS, Aurawin VDM.
*********************************************************************
WARNING: 
    While you can compile Aurawin Console on a 32bit platform, you must 
    not run Aurawin Console in Server mode in a 32bit environment.  
    Identifiers used forsocial computing methods require a 64bit
    computing environment.  
*********************************************************************
MANIFEST (AuConsole.zip):
   
   AuConsole   - GUI Application for Aurawin SCS configuration.
   Readme.txt  - this file. 
   install.sh  - shell script for installation.
   License.rtf - License agreement.
   remove.sh   - shell script for removal.
...
4.) Use AuConsole to configure server instance(s).  
    NOTICE: AuSCS is offered as a seperate download and is the actual
            binaries for operating Aurawin SCS.
