...
{Version 0.4}
unit Multimedia.ImageMagic.MagickWand;
...
uses Multimedia.ImageMagic, ctypes, DynLibs;
...
type
  ...
  {$include Multimedia.ImageMagic.PixelWand.inc}      // <- has externals
  {$include Multimedia.ImageMagic.DrawingWand.inc}    // <- has externals
  {$include Multimedia.ImageMagic.MagickAttribute.inc} // <- has externals
  {$include Multimedia.ImageMagic.PixelIterator.inc}  // <- has externals
Type
